...
from server import get_cambridge_word_info, CACHE_DIR, get_cache_path

class TestCambridgeScraper(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        # Backup existing cache if it exists
        cls.cache_backup = CACHE_DIR + "_backup_cambridge"
    ...
    def test_cambridge_scraper_basic(self):
        """Test Cambridge scraper with a common word."""
        word = "hello"
        result = get_cambridge_word_info(word, CACHE_DIR, get_cache_path)
        
        self.assertNotIn("error", result)
        self.assertEqual(result["word"].lower(), "hello")
    ...
    def test_cambridge_scraper_not_found(self):
        """Test Cambridge scraper with a non-existent word."""
    ...
    def test_caching(self):
        ...
        get_cambridge_word_info(word, CACHE_DIR, get_cache_path)
